...
assert_output_contains "wikipedia_search with topic OpenBSD (stdio)" OpenBSD\
  mcp_stdio_call "./mcphe" stdio.yaml -- tools/call "{\"name\":\"wikipedia_search\",\"arguments\":{\"query\":\"OpenBSD\"}}"
